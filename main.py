...
date = Label(frame_top, text=timegetter.date, bg='#ffb700', font='Courier 12').pack(side=LEFT, padx=25)
time = Label(frame_top, text=timegetter.vrem, bg='#ffb700', font='Courier 12').pack(side=RIGHT, padx=25)
...
USD_buy = Label(frame_bottom, text=network_getter.db, bg='#ffb700', font='Courier 12').place(x=65, y=30)
USD_sale = Label(frame_bottom, text=network_getter.ds, bg='#ffb700', font='Courier 12').place(x=65, y=60)
EUR_buy = Label(frame_bottom, text=network_getter.eb, bg='#ffb700', font='Courier 12').place(x=160, y=30)
EUR_sale = Label(frame_bottom, text=network_getter.es, bg='#ffb700', font='Courier 12').place(x=160, y=60)
